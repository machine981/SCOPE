...
ROLLOUT_N=8                  # 每个 prompt 采样条数，OPD=1，GRPO>=4
TEMPERATURE=0.6
...
# --- 算法配置 ---
ADV_ESTIMATOR=grpo           # none（纯OPD）/ grpo（GRPO）
DISTILL_ENABLE=False         # 是否启用蒸馏
...
USE_SCOPE_DUAL_PATH_WEIGHTING=False
SCOPE_TAU=1.0
SCOPE_USE_SEQ_WEIGHTS=True
TEACHER_PATH_PPL_POSITIVE=False
