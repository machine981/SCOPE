...
def compute_policy_loss(
    ...
    if entropy_weighted_flag:
        pg_losses1 = -advantages * entropy * ratio
    else:
    ...
    if entropy_weighted_flag:
        pg_losses2 = -advantages * entropy * torch.clamp(ratio, 1 - cliprange_low, 1 + cliprange_high)  # - clip(ratio, 1-cliprange, 1+cliprange) * A
    else:
    ...
    if entropy_weighted_flag:
        pg_losses3 = -advantages * entropy * clip_ratio_c
    else:
